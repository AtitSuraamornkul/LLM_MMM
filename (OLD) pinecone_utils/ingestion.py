...
index_name = "new-m150-thb"  # change if desired
...
#summary_file = "summary_output/summary_extract_output.txt"

#documents = all_json_data
#documents, summary = PROCESS_ALL.process_complete_mmm_analysis(optimization_file, summary_file)
